...
<head>
  ...
  <title>La ruta Tours</title>
  <link rel="stylesheet" href="{{ asset('/CSS/index.css') }}" />
</head>
<body>

  <!-- Imagen horizontal superior -->
  ...
  <div class="libros">
    <div class="book">
      ...
      <p>12 Asientos</p>
      <div class="cover">
        <img src="{{asset('/img/tequila.webp')}}" alt="Tequila Jalisco">
      </div>
    </div>
    ...
    <div class="book">
      ...
      <p>12 Asientos</p>
      <div class="cover">
        <img src="{{asset('/img/zoo.webp')}}" alt="Zoológico GDL">
      </div>
    </div>
    ...
    <div class="book">
     <p>12-Octubre-2025</p>
      <p>12 Asientos</p>
      <div class="cover">
        <img src="{{asset('/img/sansebas.webp')}}" alt="San Sebastián">
      </div>
    </div>

    <div class="book">
      <p>29-Noviembre-2025</p>
      <p>8 Asientos</p>
      <div class="cover">
        <img src="{{asset('/img/navidalia.webp')}}" alt="Navidalia">
      </div>
    </div>
  </div>
</section>
